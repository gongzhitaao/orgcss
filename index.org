...
#+BEGIN_abstract
This article shows off my [[http:./org.css][org.css]], a simple and clean stylesheet for
org-exported HTML file based on [[https://necolas.github.io/normalize.css/][normalize.css]].  My org template for
...
* Introduction
  ...
  [[http://orgmode.org/][orgmode.org]] or Emacs manual.  In this article, we focus on one of
  its uses, /exporting to html/.

  I will assume that readers are already familiar with Emacs and org
  mode.  In Section [[#sec:motivation]] I provide the motivation for this
  short demo.  All related configuration and templates are detailed in
  Section [[#sec:setup]].  And finally Section [[#sec:conclusion]] concludes
  this article.
